...
-- Schema super_store_sim_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `super_store_sim_db` DEFAULT CHARACTER SET utf8 ;
...
-- -----------------------------------------------------
-- Table `super_store_sim_db`.`member`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `super_store_sim_db`.`member` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `first_name` VARCHAR(45) NOT NULL,
  `last_name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `super_store_sim_db`.`order`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `super_store_sim_db`.`order` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `member_id` INT NULL,
  ...
  CONSTRAINT `mem-ord-idfk`
    ...
    REFERENCES `super_store_sim_db`.`member` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `super_store_sim_db`.`orderdetails` (
  ...
  CONSTRAINT `ord_det_idfk`
    ...
    REFERENCES `super_store_sim_db`.`order` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
